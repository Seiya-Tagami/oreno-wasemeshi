...
const Footer = () => {
  return (
    <footer className='w-full md:h-[300px] bg-black-main border-t border-gray-200 p-8 flex md:flex-row flex-col-reverse gap-36'>
      <div className="h-full flex flex-col justify-between items-start gap-2 text-white">
        <div className="flex flex-col gap-2">
          <h2 className="md:text-4xl text-3xl font-semibold">俺のわせ飯</h2>
